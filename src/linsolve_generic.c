...
*********************************************************************************/  
  ...
  MALLOC( p->polyprec_PRECISION.dirctslvr.ipiv, lapack_int, d_poly);
...
//#ifdef BLOCK_JACOBI
    ...
    printf0("| corsst g direct solve time: %-8.4lf seconds (%04.1lf%%)     |\n",
	    g.coarsest_solve_time, 100*(g.coarsest_solve_time/(t1-t0)) );   
