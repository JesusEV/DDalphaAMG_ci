...
#LIMEDIR = /home/ramirez/Documents/QUDA/installs/qio/bin
...
$(BINDIR)/DDalphaAMG : $(OBJ) 
	scorep --nocompiler $(CC) $(OPT_VERSION_FLAGS) -o $@ $(OBJ) $(H5LIB) $(LIMELIB) $(SCALAPACK_LIBRARIES) $(LAPACK_LIBRARIES) -lm -lgfortran
